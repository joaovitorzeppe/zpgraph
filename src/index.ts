...
/**
 * Zgraph — modern TypeScript charting library
 * Spiritual successor to dygraphs (MIT).
 */

// No CSS import here on purpose: a side-effect `import './style.css'` in the
// package entry makes `import Zgraph from 'zpgraph'` throw in plain Node and in
// SSR. Load `zgraph/style.css` from application code instead.

export { default } from './zgraph';
export { default as Zgraph } from './zgraph';
