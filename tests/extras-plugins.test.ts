...
describe('Hairlines plugin', () => {
  ...
  it('adds a line and an info div to the chart', () => {
    ...
    expect(g.graphDiv.querySelectorAll('.zgraph-hairline').length).toBe(1);
  ...
  it('removes the divs of a hairline that is dropped', () => {
    ...
    expect(g.graphDiv.querySelectorAll('.zgraph-hairline').length).toBe(2);
  ...
  it('marks the selected hairline with a class', () => {
    ...
    expect(g.graphDiv.querySelector('.zgraph-hairline.selected')).not.toBe(
      null,
    );
    g.destroy();
  });
...
describe('SuperAnnotations plugin', () => {
  ...
  it('adds a line and an info div to the chart', () => {
    ...
    expect(g.graphDiv.querySelectorAll('.zgraph-annotation-line').length).toBe(
      1,
    );
