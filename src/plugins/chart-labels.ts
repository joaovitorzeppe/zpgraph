...
class chart_labels {
  ...
  layout(e: LayoutPluginEvent) {
    ...
    if (g.getOption('title')) {
      ...
      class_div.className = 'zgraph-label zgraph-title';
    ...
    if (g.getOption('xlabel')) {
      ...
      let class_div = document.createElement('div');
      class_div.className = 'zgraph-label zgraph-xlabel';
...
let createRotatedDiv = function (
  ...
  inner_div.className =
    'zgraph-label-rotate-' + (axis === 1 ? 'right' : 'left');
