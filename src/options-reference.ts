...
let OPTIONS_REFERENCE: Record<string, OptionDoc> | null = null;

if (typeof process !== "undefined" && process.env.NODE_ENV !== "production") {
  // A tabela abaixo é grande e só serve para validar opções em desenvolvimento,
  // então o bundler a elimina em produção junto com este bloco.
  ...
  OPTIONS_REFERENCE =
    // <JSON>
    {
      ...
      xValueParser: {
        ...
        labels: ["CSV parsing"],
        type: "function(str: any) -> number",
        description:
          "A function which parses x-values (i.e. the dependent series). Must return a number, even when the values are dates. In this case, millis since epoch are used. This is used primarily for parsing CSV data. *=Zpgraph is slightly more accepting in the dates which it will parse. See code for details.",
      },
      stackedGraph: {
        default: "false",
      ...
      drawPointCallback: {
        default: "null",
        labels: ["Data Line display"],
        type: "function(g: any, seriesName: any, canvasContext: any, cx: any, cy: any, color: any, pointSize: any, idx: any)",
        parameters: [
      ...
      zoomCallback: {
        default: "null",
        labels: ["Callbacks"],
        type: "function(minDate: any, maxDate: any, yRanges: any)",
        parameters: [
      ...
      pointClickCallback: {
        snippet: "function(e: any, point: any){<br>  alert(point);<br>}",
        default: "null",
        labels: ["Callbacks", "Interactive Elements"],
        type: "function(e: any, point: any)",
        parameters: [
      ...
      connectSeparatedPoints: {
        ...
        type: "boolean",
        description:
          "Usually, when Zpgraph encounters a missing value in a data series, it interprets this as a gap and draws it as such. If, instead, the missing values represents an x-value for which only a different series has data, then you’ll want to connect the dots by setting this to true. To explicitly include a gap with this option set, use a value of NaN.",
      },
      highlightCallback: {
        default: "null",
        labels: ["Callbacks"],
        type: "function(event: any, x: any, points: any, row: any, seriesName: any)",
        description:
        ...
        parameters: [
          ...
          [
            "points",
            "an array of highlighted points: <code>[ {name: 'series', yval: y-value}, … ]</code>",
          ],
          [
            "row",
      ...
      includeZero: {
        ...
        type: "boolean",
        description:
          "Usually, zpgraph will use the range of the data plus some padding to set the range of the y-axis. If this option is set, the y-axis will always include zero, typically as the lowest value. This can be used to avoid exaggerating the variance in the data",
      },
      rollPeriod: {
        default: "1",
      ...
      valueFormatter: {
        ...
        type: "function(num_or_millis: any, opts: any, seriesName: any, zpgraph: any, row: any, col: any)",
        description:
        ...
        parameters: [
          ...
          [
            "zpgraph",
            "The zpgraph object for which the formatting is being done",
          ],
          [
            "row",
      ...
      annotationMouseOverHandler: {
        default: "null",
        labels: ["Annotations"],
        type: "function(annotation: any, point: any, zpgraph: any, event: any)",
        description:
      ...
      dataLoadErrorCallback: {
        default: "null",
        labels: ["Callbacks"],
        type: "function(error: any, url: any, zpgraph: any)",
        parameters: [
          ["error", "The error that aborted the load."],
          ["url", "The URL that was being fetched."],
          ["zpgraph", "The graph that requested the data."],
        ],
        description:
          "Called when chart data could not be loaded from a URL. Without it a failed load is only reported to the console, and the chart stays empty with no way for the application to react. Aborted loads (a newer `file` replacing an in-flight one) do not trigger this.",
      },
      drawCallback: {
        default: "null",
        labels: ["Callbacks"],
        type: "function(zpgraph: any, is_initial: any)",
        parameters: [
          ["zpgraph", "The graph being drawn"],
          [
            "is_initial",
        ...
        description:
          "When set, this callback gets called every time the zpgraph is drawn. This includes the initial draw, after zooming and repeatedly while panning.",
      },
      labelsKMG2: {
        default: "false",
        ...
        type: "boolean",
        description:
          "Show Ki/Mi/Gi for powers of 1024 on y-axis. If used together with <code>labelsKMB</code> (deprecated), K/M/G are used instead.",
      },
      delimiter: {
        default: ",",
        labels: ["CSV parsing"],
      ...
      underlayCallback: {
        default: "null",
        labels: ["Callbacks"],
        type: "function(context: any, area: any, zpgraph: any)",
        parameters: [
      ...
      interactionModel: {
        ...
        type: "Object",
        description:
          "Maps mouse/touch events to chart interactions (pan, zoom, highlight). Replace to customize gesture handling; see ZpgraphInteraction for the default model.",
      },
      ticker: {
        default: "Zpgraph.dateTicker or Zpgraph.numericTicks",
        labels: ["Axis display"],
        type: "function(min: any, max: any, pixels: any, opts: any, zpgraph: any, vals: any) → [{v: …, label: …}, …]",
        parameters: [
          ["min", ""],
          ["max", ""],
          ["pixels", ""],
        ...
        description:
          "This lets you specify an arbitrary function to generate tick marks on an axis. The tick marks are an array of (value, label) pairs. The built-in functions go to great lengths to choose good tick marks so, if you set this option, you’ll most likely want to call one of them and modify the result. See tickers.js for an extensive discussion. This is set on a <a href='per-axis.html'>per-axis</a> basis.",
      },
      xAxisHeight: {
        default: "(null)",
        labels: ["Axis display"],
      ...
      labelsDiv: {
        ...
        example:
          "<code style='font-size: small'>document.getElementById('foo')</code> or <code>'foo'</code>",
        description:
      ...
      wilsonInterval: {
        ...
        type: "boolean",
        description:
          'Use in conjunction with the "fractions" option. Instead of plotting +/- N standard deviations, zpgraph will compute a Wilson confidence interval and plot that. This has more reasonable behavior for ratios close to 0 or 1.',
      },
      fillGraph: {
        default: "false",
        labels: ["Data Line display"],
        type: "boolean",
        description:
          "Should the area underneath the graph be filled? This option is not compatible with <tt>customBars</tt> nor <tt>errorBars</tt>. This may be set on a <a href='per-axis.html'>per-series</a> basis.",
      },
      highlightCircleSize: {
        default: "3",
        labels: ["Interactive Elements"],
      ...
      visibility: {
        ...
        description:
          "Which series should initially be visible? Once the Zpgraph has been constructed, you can access and modify the visibility of each series using the <code>visibility</code> and <code>setVisibility</code> methods.",
      },
      valueRange: {
      ...
      legendFormatter: {
        default: "null",
        labels: ["Legend"],
        type: "function(data: any): string or DocumentFragment node",
        params: [
          [
            "data",
            'An object containing information about the selection (or lack of a selection). This includes formatted values and series information. See <a href="legend-formatter.md"><tt>docs/legend-formatter.md</tt></a> (<a href="https://github.com/danvk/zpgraph/blob/master/docs/legend-formatter.md">online</a>) for sample values.',
          ],
        ],
        description:
          'Set this to supply a custom formatter for the legend. See <a href="legend-formatter.md"><tt>docs/legend-formatter.md</tt></a> (<a href="https://github.com/danvk/zpgraph/blob/master/docs/legend-formatter.md">online</a>) and the <a href="tests/legend-formatter.html">legendFormatter demo</a> for usage.',
      },
      ...
      rightGap: {
        ...
        type: "integer",
        description:
          "Number of pixels to leave blank at the right edge of the Zpgraph. This makes it easier to highlight the right-most data point.",
      },
      drawAxesAtZero: {
        default: "false",
        labels: ["Axis display"],
      ...
      axisLabelFormatter: {
        ...
        labels: ["Axis display"],
        type: "function(number_or_Date: any, granularity: any, opts: any, zpgraph: any)",
        parameters: [
          [
            "number_or_Date",
          ...
          [
            "granularity",
            "specifies how fine-grained the axis is. For date axes, this is a reference to the time granularity enumeration, defined in tickers.js, e.g. Zpgraph.WEEKLY.",
          ],
          [
            "opts",
            "a function which provides access to various options on the zpgraph, e.g. opts('labelsKMB').",
          ],
          ["zpgraph", "the referenced graph"],
        ],
        description:
      ...
      clickCallback: {
        snippet:
          "function(e: any, date_millis: any){<br>  alert(new Date(date_millis));<br>}",
        default: "null",
        labels: ["Callbacks"],
        type: "function(e: any, x: any, points: any)",
        parameters: [
          ["e", "The event object for the click"],
          [
            "x",
      ...
      labels: {
        ...
        type: "Array of strings",
        description:
          "A distinct name for each data series, including the independent (X) series. For CSV files and DataTable objects, this is determined by context. For raw data, this must be specified. If it is not, default values are supplied and a warning is logged. Make sure no two names are the same!",
      },
      dateWindow: {
        default: "Full range of the input is shown",
        labels: ["Axis display"],
      ...
      customBars: {
        ...
        type: "boolean",
        description:
          'When set, parse each CSV cell as "low;middle;high". Custom high/low bands will be drawn for each point between low and high, with the series itself going through middle.',
      },
      colorValue: {
        default: "1.0",
        labels: ["Data Series Colors"],
      ...
      displayAnnotations: {
        ...
        type: "boolean",
        description:
          "Only applies when Zpgraph is used as a GViz chart. Causes string columns following a data series to be interpreted as annotations on points in that series. This is the same format used by Google’s AnnotatedTimeLine chart.",
      },
      panEdgeFraction: {
        default: "null",
      ...
      title: {
        ...
        default: "null",
        description:
          "Text to display above the chart. You can supply any HTML for this value, not just text. If you wish to style it using CSS, use the “zpgraph-label” or “zpgraph-title” classes.",
      },
      titleHeight: {
        default: "18",
        labels: ["Chart labels"],
      ...
      xlabel: {
        ...
        default: "null",
        description:
          "Text to display below the chart’s x-axis. You can supply any HTML for this value, not just text. If you wish to style it using CSS, use the “zpgraph-label” or “zpgraph-xlabel” classes.",
      },
      xLabelHeight: {
        labels: ["Chart labels"],
        type: "integer",
      ...
      y2label: {
        ...
        default: "null",
        description:
          "Text to display to the right of the chart’s secondary y-axis. This label is only displayed if a secondary y-axis is present. See <a href='tests/two-axes.html'>this test</a> for an example of how to do this. The comments for the “ylabel” option generally apply here as well. This label gets a “zpgraph-y2label” instead of a “zpgraph-ylabel” class.",
      },
      yLabelWidth: {
        labels: ["Chart labels"],
        type: "integer",
      ...
      sigFigs: {
        ...
        type: "integer",
        description:
          "By default, zpgraph displays numbers with a fixed number of digits after the decimal point. If you’d prefer to have a fixed number of significant figures, set this option to that number of sig figs. A value of 2, for instance, would cause 1 to be display as 1.0 and 1234 to be displayed as 1.23e+3.",
      },
      digitsAfterDecimal: {
        default: "2",
        labels: ["Value display/formatting"],
        type: "integer",
        description:
          "Unless it’s run in scientific mode (see the <code>sigFigs</code> option), zpgraph displays numbers with <code>digitsAfterDecimal</code> digits after the decimal point. Trailing zeros are not displayed, so with a value of 2 you’ll get '0', '0.1', '0.12', '123.45' but not '123.456' (it will be rounded to '123.46'). Numbers with absolute value less than 0.1^digitsAfterDecimal (i.e. those which would show up as '0.00') will be displayed in scientific notation.",
      },
      maxNumberWidth: {
        default: "6",
        labels: ["Value display/formatting"],
        type: "integer",
        description:
          "When displaying numbers in normal (not scientific) mode, large numbers will be displayed with many trailing zeros (e.g. 100000000 instead of 1e9). This can lead to unwieldy y-axis labels. If there are more than <code>maxNumberWidth</code> digits to the left of the decimal in a number, zpgraph will switch to scientific notation, even when not operating in scientific mode. If you’d like to see all those digits, set this to something large, like 20 or 30.",
      },
      file: {
        ...
        description:
          "Sets the data being displayed in the chart. This can only be set when calling updateOptions; it cannot be set from the constructor. For a full description of valid data formats, see the <a href='data.html'>Data Formats</a> page.",
      },
      timingName: {
        default: "null",
        ...
        type: "string",
        description:
          "Set this option to log timing information. The value of the option will be logged along with the timimg, so that you can distinguish multiple zpgraph on the same page.",
      },
      showRangeSelector: {
        default: "false",
      ...
      rangeSelectorHeight: {
        ...
        type: "integer",
        description:
          "Height, in pixels, of the range selector widget. This option can only be specified at Zpgraph creation time.",
      },
      ...
      plotter: {
        default:
          "[ZpgraphCanvasRenderer.Plotters.fillPlotter, ZpgraphCanvasRenderer.Plotters.errorPlotter, ZpgraphCanvasRenderer.Plotters.linePlotter]",
        labels: ["Data Line display"],
        type: "array or function",
        description:
          "A function (or array of functions) that draws each data series. Each plotter receives the canvas context and series data; the default chain fills, draws error bars, then strokes lines. May be set per-series.",
      },
      axes: {
        default: "null",
        ...
        type: "Object",
        description:
          "Defines per-axis options. Valid keys are 'x', 'y' and 'y2'. Only some options may be set on a per-axis basis. If an option may be set in this way, it will be noted on this page. See also documentation on <a href='per-axis.html'>per-series and per-axis options</a>.",
      },
      series: {
        default: "null",
        labels: ["Series"],
  ...
  const valid_cats =
    // <JSON>
    {
      ...
      Deprecated: "",
      "Error Bars":
        "These are actually high/low bands, not error bars; the misnomer is historic.",
      Grid: "",
